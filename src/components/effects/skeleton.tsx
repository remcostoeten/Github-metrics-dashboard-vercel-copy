const Skeleton = ({ className }) => (
  ...
  const LoadingSkeleton = () => (
    <>
      <div className="flex flex-col grow pb-9 -mt-5 max-md:mt-10 max-md:max-w-full space-y-2">
        <div className="flex flex-col shadow-lg border border-zinc-800">
          <div className="flex justify-between items-center px-4 py-4">
            <h2 className="tracking-tight">
              <Skeleton className="w-[128px] max-w-full" />
            </h2>
            <div className="box-border leading-[32px] block h-[32px] justify-center min-w-min relative w-[66.925px] px-[18.4px] py-0 border-[0.8px] border-solid border-zinc-800">
          ...
          <div className="flex gap-2.5 px-5 py-5 border-t border-zinc-800">
